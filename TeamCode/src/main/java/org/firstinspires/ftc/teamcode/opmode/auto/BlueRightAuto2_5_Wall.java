...
@Autonomous(name = "Blue Right Auto 2+5 Wall", group = "Auto")
public class BlueRightAuto2_5_Wall extends AutoBase {
    ...
    public static Waypoint intermediate = new Waypoint( new Pose(-36, 60.5, Math.toRadians(180)), 20);
    ...
    protected void printDescription() {
        telemetry.addData("Description", "Blue Right Auto 2+5 Wall");
    }
