...
public class RedRightAuto extends AutoBase {
      ...
      sched.addAction(
              new SequentialAction(
                      ...
                      drive.actionBuilder(scoring[SPIKE])
                              ...
                              .strafeToLinearHeading(scoring[SPIKE].position.plus(new Vector2d(SPIKE != 2 ? 10 : 20, 0)), scoring[SPIKE].heading) // Correct for any turning that occured during the previous move
                              .build(),
   ...
   private void park() {
      sched.addAction(
              drive.actionBuilder(new Pose2d(scoring[SPIKE].position.plus(new Vector2d(SPIKE != 2 ? 10 : 20, 0)),
