...
public class BlueLeftAuto extends AutoBase {
   ...
   public static Pose2d[] stackPositions = {
           new Pose2d(-53, 14, Math.toRadians(180)),
           new Pose2d(-53, 14, Math.toRadians(180)),
           new Pose2d(-53, 14, Math.toRadians(180))
   };
      ...
      sched.addAction(
              new SequentialAction(
                      ...
                      drive.actionBuilder(stack)
                              ...
                              .strafeToLinearHeading(new Vector2d((AutoConstants.blueScoring[SPIKE].position.x*8 + stack.position.x)/9, stack.position.y), AutoConstants.blueScoring[SPIKE].heading)
