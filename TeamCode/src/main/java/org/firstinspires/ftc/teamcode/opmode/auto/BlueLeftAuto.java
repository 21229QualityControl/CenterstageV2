...
public class BlueLeftAuto extends AutoBase {
   public static Vector2d[] spike = {new Vector2d(-2, 34), new Vector2d(10, 34), new Vector2d(22, 40)};
   // 0 = right, 1 = middle, 2 = left
   public static Pose2d start = new Pose2d(12, 64, Math.toRadians(90));
   public static Pose2d[] scoring = {new Pose2d(25, 28, Math.toRadians(180)), new Pose2d(40, 34, Math.toRadians(180)), new Pose2d(40, 40, Math.toRadians(180))};
      ...
      sched.addAction(
              new SequentialAction(
                      ...
                      drive.actionBuilder(scoring[SPIKE])
                              ...
                              .strafeToLinearHeading(scoring[SPIKE].position.plus(new Vector2d(SPIKE != 0 ? 10 : 25, 0)), scoring[SPIKE].heading) // Correct for any turning that occured during the previous move
                              .build(),
   ...
   private void park() {
      sched.addAction(
                   drive.actionBuilder(new Pose2d(scoring[SPIKE].position.plus(new Vector2d(SPIKE != 0 ? 10 : 25, 0)),
