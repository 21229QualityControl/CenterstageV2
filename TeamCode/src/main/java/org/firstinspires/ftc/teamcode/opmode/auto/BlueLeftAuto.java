...
public class BlueLeftAuto extends AutoBase {
   public static Vector2d[] spike = {new Vector2d(0, 34), new Vector2d(12, 36), new Vector2d(24, 40)};
   // 0 = right, 1 = middle, 2 = left
   public static Pose2d start = new Pose2d(12, 64, Math.toRadians(90));
   public static Pose2d[] scoring = {new Pose2d(40, 28, Math.toRadians(180)), new Pose2d(40, 34, Math.toRadians(180)), new Pose2d(40, 38, Math.toRadians(180))};
