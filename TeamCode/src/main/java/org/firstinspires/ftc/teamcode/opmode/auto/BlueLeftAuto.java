...
public class BlueLeftAuto extends AutoBase {
   public static Pose2d[] spike = {new Pose2d(9, 38, Math.toRadians(45)), new Pose2d(12, 40, Math.toRadians(90)), new Pose2d(24, 42, Math.toRadians(90))};
   ...
   public static Pose2d[] scoring = {new Pose2d(42, 30, Math.toRadians(180)), new Pose2d(42, 36, Math.toRadians(180)), new Pose2d(42, 42, Math.toRadians(180))};
